...
FX_VOID	        FX_MatrixRotX(Matrix4 L, FX_DOUBLE DegAngle, Matrix4 T);
FX_VOID	        FX_MatrixRotY(Matrix4 L, FX_DOUBLE DegAngle, Matrix4 T);
FX_VOID	        FX_MatrixRotZ(Matrix4 L, FX_DOUBLE DegAngle, Matrix4 T);
FX_VOID         FX_MatrixMoveXYZ(Matrix4 L, Vect3 xyz, Matrix4 T);
